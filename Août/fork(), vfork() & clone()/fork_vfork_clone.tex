...
\inputminted[linenos, fontsize=\small, breaklines]{c}{codes/fork.c}
\newpage
\subsection{Resultat}
\begin{lstlisting}
...
\inputminted[linenos, fontsize=\small, breaklines]{c}{codes/vfork.c}
\subsection{Résultat}
\begin{lstlisting}
CODES D'ÉTAT DE PROCESSUS 
Voici les différentes valeurs que les indicateurs de sortie s, stat et state (en-tête "STAT" ou "S") afficheront pour décrire l'état d'un processus :
...
\end{normalsize}
\inputminted[linenos, fontsize=\small, breaklines]{c}{codes/vforkParentPAUSED.c}
\newpage
\subsection{Résultat}
\begin{lstlisting}
...
\inputminted[linenos, fontsize=\small, breaklines]{c}{codes/clone.c}
