...
\end{lstlisting}
\textit{Suite à un problème ancien de cache, ainsi qu'à d'autres problèmes traités dans getpid(2), la fonctionnalité de mise en cache du PID a été supprimée de la glibc 2.25.}
\subsection{Code}
...
\\Donc, pour tout programme un minimum lourd, il est meilleur d'implémenter clone() avec les flags nécessaires afin d'utiliser la mémoire virtuelle de manière pertinente et efficace.
